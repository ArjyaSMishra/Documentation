...
Hypothesis 2 i.e., \textbf{H$_{OP2}$} and \textbf{H$_{NU2}$} is designed to investigate research question \textbf{RQ 4.1}. This hypothesis deals with the fact whether demon-bx tool has a positive effect on the achievement of corresponding bx-related learning goals. Data for \textbf{RQ 4.1} can be collected from the improvement calculated for control group (\textit{IMP$_{(c_i)}$}) and treated group (\textit{IMP$_{(t_i)}$}) separately. Because both control and treated group have used demon-bx tool (with different environments) before posttest and improvement indicates how much a certain group has improved/learned from pretest to posttest. 

As five questions were asked, the improvement can be calculated for each question from the pretest and posttest data separately for control and treated group. 
...
To gain an even better understanding of the data, I have further analyzed it with a t-test. As this hypothesis is related to one set of improvement data at a time i.e., either the improvement for control group or the improvement of treated group, I have used the one-sample t-test.   
...
\begin{table}[ht]
	...
	\begin{tabular}{|p{1cm}|p{1.5cm}|p{4.5cm}|p{1.5cm}|p{1.5cm}|p{1.5cm}|}
		...
		\textbf{} & \textbf{Students} & \textbf{Factor} & \textbf{t-value} & \textbf{p-value} & \textbf{mean}\\
		\hline
		Q1 & 21 & improvement (control grp) &  -1.7589 & 0.9531 & -0.1904\\
		\hline
		Q2 & 21 & improvement (control grp) & 0.3841 & 0.3524 & 0.0357\\
		\hline
		Q3 & 21 & improvement (control grp) & -0.9604 & 0.8259 & -0.8928\\
		\hline	
		Q4 & 21 & improvement (control grp) & 0.2071 & 0.419 & 0.0238\\
		\hline
		Q5 & 21 & improvement (control grp) & -0.7853 & 0.7793 & -0.8333\\
		\hline			
	\end{tabular}
...
\begin{table}[ht]
	...
	\begin{tabular}{|p{1cm}|p{1.5cm}|p{4.5cm}|p{1.5cm}|p{1.5cm}|p{1.5cm}|}
		...
		\textbf{} & \textbf{Students} & \textbf{Factor} & \textbf{t-value} & \textbf{p-value} & \textbf{mean}\\
		\hline
		Q1 & 18 & improvement (treated grp) &  -1.5226 & 0.9269 & -0.125\\
		\hline
		Q2 & 18 & improvement (treated grp) & -2.3739 & 0.9852 & -0.1527\\
		\hline
		Q3 & 18 & improvement (treated grp) & -0.9578 & 0.5376 & -0.0069\\
		\hline	
		Q4 & 18 & improvement (treated grp) & 0.8911 & 0.1927 & 0.0486\\
		\hline
		Q5 & 18 & improvement (treated grp) & -0.6439 & 0.7359 & -0.0625\\
		\hline			
	\end{tabular}
