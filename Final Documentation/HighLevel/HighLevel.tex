...
\subsection{Implementation Idea}\label{subsec:implementation}
...
\subsubsection{Choosing an Example}\label{subsubsec:examples}
We have discussed a few examples for implementation as follows:
...
\subsection{BX Tool Selection}\label{subsec:bxtool}
